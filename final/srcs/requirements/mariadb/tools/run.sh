...
mysql -e "ALTER USER '${MARIADB_ROOT_USER}'@'localhost' IDENTIFIED BY '${MARIADB_ROOT_PASSWORD}';"
mysql -e "FLUSH PRIVILEGES;"

#shutdown server
# mysqladmin --user=${MYSQL_ROOT_USER} --password=${MYSQL_ROOT_PASSWORD} shutdown
